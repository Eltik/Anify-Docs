...
<Tabs items={["Parameters", "Query", "Post"]}>
    <Tab>
        <>
            ```
            https://api.anify.tv/search/{type}/{query}
            ```
        </>
...
|   apikey  | string | Whitelisted API key |    No    |  `""`   |
        ...
        <Tabs items={["JavaScript", "Python"]}>
            <Tab>
                <>
                    ...
                    const url = `https://api.anify.tv/search/anime/mushoku%20tensei`;
                    const data = async () => {
                        try {
            ...
            <Tab>
                <>
                    ...
                    # Using the example query "mushoku tensei"
                    url = "https://api.anify.tv/search/anime/mushoku%20tensei"
    ...
    <Tab>
        <>
            ```
            https://api.anify.tv/search?type={type}&query={query}
            ```
        </>
| Parameter |  Type  | Description                                                       | Required? | Default |
| :-------: | :----: | ----------------------------------------------------------------- | :-------: | :-----: |
        ...
        <Tabs items={["JavaScript", "Python"]}>
            <Tab>
                <>
                    ...
                    // Using the example query "mushoku tensei"
                    const url = `https://api.anify.tv/search?type=anime&query=mushoku%20tensei`;
                    const data = async () => {
                        try {
                            const { data } = await axios.get(url);
                            return data;
            ...
            <Tab>
                <>
                    ...
                    # Using the example query "mushoku tensei"
                    url = "https://api.anify.tv/search?type=anime&query=mushoku%20tensei"
                    response = requests.get(url)
                    data = response.json()
