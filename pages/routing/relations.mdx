...
<Tabs items={["Parameters", "Query", "Post"]}>
    <Tab>
        <>
            ```
            https://api.anify.tv/relations/{id}
            ```
        </>
        ...
        <Tabs items={["JavaScript", "Python"]}>
            <Tab>
                <>
                    ...
                    const url = `https://api.anify.tv/relations/a25e46ec-30f7-4db6-89df-cacbc1d9a900`;
                    const data = async () => {
                        try {
            ...
            <Tab>
                <>
                    ...
                    url = "https://api.anify.tv/relations/a25e46ec-30f7-4db6-89df-cacbc1d9a900"
        ...
        <Tabs items={["JavaScript", "Python"]}>
            <Tab>
                <>
                    ...
                    const url = `https://api.anify.tv/relations?id=a25e46ec-30f7-4db6-89df-cacbc1d9a900`;
                    const data = async () => {
                        try {
                            const { data } = await axios.get(url);
                            return data;
            ...
            <Tab>
                <>
                    ...
                    url = "https://api.anify.tv/relations?id=a25e46ec-30f7-4db6-89df-cacbc1d9a900"
                    response = requests.get(url)
                    data = response.json()
